...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        perm_mask = np.random.permutation(self.obs.shape[0])
        return self.obs[perm_mask < batch_size], self.acs[perm_mask < batch_size], self.rews[perm_mask < batch_size], self.next_obs[perm_mask < batch_size], self.terminals[perm_mask < batch_size]
